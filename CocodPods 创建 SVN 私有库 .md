...
#### <a name="install-cocoapods-repo-svn">安装 CocoaPods 插件</a>
...
#### <a name="create-spec-svn">创建`Spec`SVN 仓库</a>
...
#### <a name="create-private-repo">添加 CocoaPods 私有 Repo</a>

#### <a name="create-framework-svn">创建私有库的 SVN 仓库</a>
...
#### <a name="create-podspec-file">编写podsepc文件</a>

#### <a name="create-podfile">Podfile</a>
